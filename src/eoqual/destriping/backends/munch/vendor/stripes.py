# Vendored verbatim from https://github.com/DHI-GRAS/rmstripes
# (rmstripes/stripes.py, commit history stops at 2018-12-20) — MIT License,
# Copyright (c) 2018 DHI GRAS. See LICENSE in this directory.
#
# Vendored rather than depended-on: rmstripes' own packaging (versioneer.py)
# calls configparser.SafeConfigParser(), removed in Python 3.12, which makes
# `pip install rmstripes` fail on 3.12 regardless of this file's own code —
# see THIRD_PARTY_LICENSES.md. Not modified below.
